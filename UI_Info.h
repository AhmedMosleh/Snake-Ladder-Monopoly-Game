...
enum DESIGN_MODE_ITEMS // The items of the Design Mode (you should add more items)
{
	...
	ITM_ADD_SNAKE,
	ITM_ADD_CARD,
	ITM_COPY_CARD,		// Copy Card Action
	ITM_PASTE_CARD,		// Paste Card Action
	ITM_CUT_CARD,		// Cut Card Action
	ITM_DELETE_OPJECT,	// Delete Game Object Card Action
	ITM_SAVE_GRID,		// Save Grid Card Action
	ITM_OPEN_GRID,		// Open Grid Card Action
