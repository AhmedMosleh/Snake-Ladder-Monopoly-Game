...
void Grid::SaveInterface(ofstream& OutFile, ObjectType Type)
{
...
Cell* Grid::getCellPointer(CellPosition position)
{
	Cell* x = CellList[position.VCell()][position.HCell()];
	return x;
}
...
Cell* Grid::GetCellFromPos(CellPosition Pos)
{
