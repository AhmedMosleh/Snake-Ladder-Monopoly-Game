...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_COPY_CARD] = "images\\Menu_CopyCard_2.jpg";
	MenuItemImages[ITM_PASTE_CARD] = "images\\Menu_PastCard_2.jpg";
	MenuItemImages[ITM_CUT_CARD] = "images\\Menu_CutCard_1.jpg";
	MenuItemImages[ITM_DELETE_OPJECT] = "images\\Menu_DeleteCard.jpg";
	MenuItemImages[ITM_SAVE_GRID] = "images\\Menu_SaveGrid_1.jpg";
	MenuItemImages[ITM_OPEN_GRID] = "images\\Menu_OpenGrid_2.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_DICE_VALUE] = "images\\Menu_DiceValue_5.jpg";
...
/*********************************************************************************************/
void Output::PrintInteger(int num) const	//Prints an integer on status bar
{
	ClearStatusBar();	// First clear the status bar from any previous writing
	...
	pWind->SetPen(UI.MsgColor);
	pWind->SetFont(18, BOLD, BY_NAME, "Verdana");
	pWind->DrawInteger(10, UI.height - (int)(UI.StatusBarHeight / 1.3), num);
}
