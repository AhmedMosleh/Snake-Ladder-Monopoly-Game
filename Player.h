...
public:
	...
	void SetTurnCount();			// a setter for turn count.
	...
	void SetjustRollDice(int num);			// a setter for just rolled dice
	int GetjustRolledDiceNum();		// a getter for just rolled dice
	...
	void PlayerInitialCondition();				// for new game action
};
